...
$data=array(array(
                ...
                array(
                    ...
                    'type'=>'date',
                    'id'=>'mou_date',
                    'def'=>isset($mou_data)?$mou_data->mou_date?$mou_data->mou_date:date('Y-m-d'):'',
                ...
                array(
                    ...
                    'type'=>'date',
                    'id'=>'mou_start_date',
                    'def'=>isset($mou_data)?$mou_data->mou_start_date?$mou_data->mou_start_date:date('Y-m-d'):'',
                    'max'=>date(('Y-m-d'),strtotime(' + 365 day')),
                    'min'=>date(('Y-m-d'),strtotime(' - 100 year')),
                    'required'=>true,
                ),
                array(
                    ...
                    'type'=>'date',
                    'id'=>'mou_end_date',
                    'def'=>isset($mou_data)?$mou_data->mou_end_date?$mou_data->mou_end_date:date('Y-m-d',strtotime(' + 3 year')):'',
